...
export const TRANSLATIONS = {
  en: {
    ...
    deviceHistoryDesc: 'Activity logs for',
    noHistory: 'No session history found for this user.',
    duration: 'Duration',
    lessThanMin: '< 1 min',
    unknown: 'Unknown',
    windows: 'Windows',
    ...
    multiDeviceAlert: 'Multiple devices detected',
    multiDeviceDesc: 'User is currently active on multiple devices.',
    devices: 'Devices',
    // Admin Reports
  ...
  ar: {
    ...
    deviceHistoryDesc: 'سجلات النشاط للمستخدم',
    noHistory: 'لا يوجد سجل دخول لهذا المستخدم.',
    duration: 'المدة',
    ...
    firefox: 'فايرفوكس',
    edge: 'إيدج',
    totalLogins: 'إجمالي مرات الدخول',
    uniqueDevices: 'أجهزة فريدة',
    securityAlert: 'تنبيه أمني',
    multiDeviceAlert: 'تعدد أجهزة',
    multiDeviceDesc: 'المستخدم نشط حالياً من أكثر من جهاز في نفس الوقت.',
    devices: 'أجهزة',
    // Admin Reports
